...
@section('contenido')
    ...
    @endsection
          ...
          <tbody>
            @foreach($ejecutado_prod_upab as $p)
            <tr>
         ...
         <legend> INGRESOS </legend>
          ...
          <tbody>
            @foreach($proyeccion_ingresos_upab as $pi)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/proyeccion_ingresos_upab/{{$pi->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> PROGRAMACIÓN DE INGRESOS (VOLÚMENES Y VALORES DE VENTA) </legend>
          ...
          <tbody>
            @foreach($programacion_ingresos_upab as $pri)
            <tr>
              <td>{{$pri->fecha3}}</td>
              <td>{{$pri->cantidad}}</td>
              <td>{{$pri->precio}}</td>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/programacion_ingresos_upab/{{$pri->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> EJECUCIÓN PRESUPUESTARIA DE GASTOS</legend>
          ...
          <tbody>
            @foreach($presupuestogastado_upab as $pg)
            <tr>
              <td>{{$pg->grupo}}</td>
         ...
         <legend> ESTADO DE RECURSOS Y GASTOS CORRIENTES </legend> <!--PANTALLA DE INICIO-->
          ...
          <tbody>
            @foreach($ejecucion_gastos_upab as $eg)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/ejecucion_gastos_upab/{{$eg->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> INVENTARIO PRODUCTOS TERMINADOS </legend> <!--PANTALLA DE INICIO-->
          ...
          <tbody>
            @foreach($inventario_productos_upab as $ip)
            <tr>
              <td>{{$ip->detalle}}</td>
              <td>{{$ip->unidad1}}</td>
              <td>{{$ip->cantidad1}}</td>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/inventario_productos_upab/{{$ip->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
          ...
          <tbody>
            @foreach($cuentas_cobro_upab as $cc)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/cuentas_cobro_upab/{{$cc->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
