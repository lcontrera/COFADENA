...
@section('contenido')
    ...
    @endsection
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/productos_fbm/{{$d->id}}/edit">
          ...
          <tbody>
            @foreach($ejecutado_prod_fbm as $p)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/ejecutado_prod_fbm/{{$p->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> INGRESOS </legend>
          ...
          <tbody>
            @foreach($proyeccion_ingresos_fbm as $pi)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/proyeccion_ingresos_fbm/{{$pi->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> PROGRAMACIÓN DE INGRESOS (VOLÚMENES Y VALORES DE VENTA) </legend>
          ...
          <tbody>
            @foreach($programacion_ingresos_fbm as $pri)
            <tr>
              <td>{{$pri->fecha3}}</td>
              <td>{{$pri->cantidad}}</td>
              <td>{{$pri->precio}}</td>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/programacion_ingresos_fbm/{{$pri->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> EJECUCIÓN PRESUPUESTARIA DE GASTOS</legend>
          ...
          <tbody>
            @foreach($presupuestogastado_fbm as $pg)
            <tr>
              <td>{{$pg->grupo}}</td>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/presupuestogastado_fbm/{{$pri->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> ESTADO DE RECURSOS Y GASTOS CORRIENTES </legend> <!--PANTALLA DE INICIO-->
          ...
          <tbody>
            @foreach($ejecucion_gastos_fbm as $eg)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/ejecucion_gastos_fbm/{{$eg->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
         ...
         <legend> INVENTARIO PRODUCTOS TERMINADOS </legend> <!--PANTALLA DE INICIO-->
          ...
          <tbody>
            @foreach($inventario_productos_fbm as $ip)
            <tr>
              <td>{{$ip->detalle}}</td>
              <td>{{$ip->unidad1}}</td>
              <td>{{$ip->cantidad1}}</td>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/inventario_productos_fbm/{{$ip->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
          ...
          <tbody>
            @foreach($cuentas_cobro_fbm as $cc)
            <tr>
              ...
              <td>
                <!--recordar modificar edit C empresas-->
                <a href="/cuentas_cobro_fbm/{{$cc->id}}/edit">
                  <button type="button" class="btn btn-primary">Editar</button>
                </a>
              </td>
            </tr>
