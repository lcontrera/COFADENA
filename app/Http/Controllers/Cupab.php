   ...
   public function buscar(Request $request)
    {
       ...
       return view('empresas/Vupab',['ejecutado_prods'=>$ejecutado_prods]);
    }
     public function indexgraphupab(){
         $ejecucion_gastoss = Mejecucion_gastos::getejecucion_gastoss("2");
         $presupuestogastadJson = Mpresupuestogastado::getpresupuestogastadJSON("2");
    ...
    public function index()
    {
        $prog_anual_prods = Mprog_anual_prod::getprog_anual_prods('2');
            ...
            $proyeccion_ingresoss = Mproyeccion_ingresos::getproyeccion_ingresoss('2');
              ...
              $presupuestogastad = Mpresupuestogastado::getpresupuestogastad('2');
               $ejecucion_gastoss = Mejecucion_gastos::getejecucion_gastoss('2');
