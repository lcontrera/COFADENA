...
public function buscar(Request $request)
    {
       ...
       return view('empresas/Vug23',['ejecutado_prods'=>$ejecutado_prods]);
    }
    public function rangofechaprod(){
     ...
     public function indexgraph(){
        ...
        $presupuestogastad = Mpresupuestogastado::getpresupuestogastadJSON("3");
    ...
    public function index()
    {
        $prog_anual_prods = Mprog_anual_prod::getprog_anual_prods('3');
            ...
            $proyeccion_ingresoss = Mproyeccion_ingresos::getproyeccion_ingresoss('3');
              ...
              $presupuestogastad = Mpresupuestogastado::getpresupuestogastad('3');
               $ejecucion_gastoss = Mejecucion_gastos::getejecucion_gastoss('3');
