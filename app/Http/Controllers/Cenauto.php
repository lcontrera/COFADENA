  ...
  public function buscar(Request $request)
    {
       ...
       return view('empresas/Venauto',['ejecutado_prods'=>$ejecutado_prods]);
    }
    public function rangofechaprod(){
     ...
     public function indexgraph(){
        ...
        $presupuestogastad = Mpresupuestogastado::getpresupuestogastadJSON("4");
    ...
    public function index()
    {
        $prog_anual_prods = Mprog_anual_prod::getprog_anual_prods('4');
            ...
            $proyeccion_ingresoss = Mproyeccion_ingresos::getproyeccion_ingresoss('4');
              ...
              $presupuestogastad = Mpresupuestogastado::getpresupuestogastad('4');
               $ejecucion_gastoss = Mejecucion_gastos::getejecucion_gastoss('4');
